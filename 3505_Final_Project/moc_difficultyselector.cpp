...
void difficultyselector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->playGame((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            typedef void (difficultyselector::*_t)(int );
...
void *difficultyselector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_difficultyselector.stringdata0))
        return static_cast<void*>(const_cast< difficultyselector*>(this));
...
// SIGNAL 0
void difficultyselector::playGame(int _t1)
{
